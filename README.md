...
[![Go Report Card](https://goreportcard.com/badge/github.com/JuanzelS/makesite)](https://goreportcard.com/report/github.com/JuanzelS/makesite)
...
- [ ] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [ ] **_FILL IN THE BLANK_**: `I will use the goldmark library library. The documentation is located at https://pkg.go.dev/github.com/yuin/goldmark. My goal is to use it toparse Markdown (.md) files and convert headings, lists, etc. into valid HTML.`
- [ ] **Add, commit, and push to GitHub**.
